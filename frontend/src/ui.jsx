...
import { ConcatNode } from './nodes/ConcatNode.jsx';
import { UppercaseNode } from './nodes/UppercaseNode.jsx';
  ...
  return (
    <div ref={reactFlowWrapper} style={{ width: '100%', height: '100%' }}>
      <ReactFlow
        ...
        fitView
      >
        <Background color="#2a3a5e" gap={gridSize} />
        <Controls />
        <MiniMap maskColor="#0b1220" />
      </ReactFlow>
    </div>
  );
};
